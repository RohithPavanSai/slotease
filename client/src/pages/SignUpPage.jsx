    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-pink-100 to-purple-200 p-4">
      ...
      >
        <div className="text-center mb-6">
          ...
          <p className="text-gray-500">Enter your location and we’ll fetch lat/lng automatically.</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-600">Register As</label>
            <select
              name="role"
              value={form.role}
              onChange={handleChange}
          ...
          <div>
            ...
            {form.location.lat && form.location.lng && (
              <p className="text-gray-500 text-sm mt-1">
                Latitude: {form.location.lat.toFixed(6)}, Longitude: {form.location.lng.toFixed(6)}
              </p>
            )}
          </div>
